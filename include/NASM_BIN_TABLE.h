...
// mov [rsp + arg], rax
#define MOV_TO_STACK_4_BYTE(arg_)  (INSTRUCTION { 0x24848948,  4,       2, arg_ })
...
// mov rax, [rsp + arg]
#define MOV_RAX_STACK_4_BYTE(arg_) (INSTRUCTION { 0x24848B48,  4,       2, arg_ })

// mov rax, [rbp + arg]
#define MOV_RAX_RBP_4_BYTE(arg_)   (INSTRUCTION { 0x24848B48,  4,       2, arg_ })
